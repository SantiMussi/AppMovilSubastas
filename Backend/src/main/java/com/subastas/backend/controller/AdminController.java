...
public class AdminController {
    ...
    @PostMapping("/proposals/{propuestaId}/assign")
    public AsignarPropuestaResponse asignarPropuesta(
            @PathVariable Integer propuestaId,
            @Valid @RequestBody AsignarPropuestaRequest req) {
        return adminService.asignarPropuesta(currentUser.obtenerEmpleadoId(), propuestaId, req);
    }
